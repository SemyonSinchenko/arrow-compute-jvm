...
import io.github.semyonsinchenko.arrowcompute.compute.raw.AddFloat64Raw;
 ...
 * Output validity rule: left & right. Aliasing assumption: inputs and output are non-overlapping.
 * Input mutation: never.</p>
 */
public final class AddFloat64 {
    ...
    public static void eval(Float8Vector left, Float8Vector right, Float8Vector out) {
        ...
        try (var refs = BufferRefs.retain(left, right, out)) {
            ...
            if (n > 0) {
                ...
                AddFloat64Raw.computeAll(leftData, rightData, outData, n);
            }
            out.setValueCount(n);
        }
    }

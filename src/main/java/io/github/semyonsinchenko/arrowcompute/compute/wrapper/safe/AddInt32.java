 ...
 * for all rows. Overflow semantics: Java int wraparound. Output validity rule: left & right.
 * Aliasing assumption: inputs and output are non-overlapping. Input mutation: never.</p>
 */
